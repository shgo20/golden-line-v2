        ...
        <div className="faq-inner">
          ...
          <div className="faq-cta">
            <p className="faq-cta-label">
              ...
              <strong>Contact us directly — we respond within 24 hours.</strong>
            </p>
            <a href={`https://wa.me/966599799300`} target="_blank" rel="noopener noreferrer" className="btn-primary">
