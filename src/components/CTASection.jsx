    ...
    <>
      ...
      <section className="cta-section">
        ...
        <div className="cta-inner">
          <div>
            <span className="cta-title-en">{tr(T.cta.subtitle, lang)}</span>
            <h2 className="cta-title">
              {tr(T.cta.title1, lang)}<br />
              <strong>{tr(T.cta.title2, lang)}</strong> {tr(T.cta.title3, lang)}
            </h2>
            <p className="cta-body">{tr(T.cta.body, lang)}</p>
            <div className="cta-buttons">
              <a href="#contact" className="btn-primary">{tr(T.cta.quote, lang)}</a>
