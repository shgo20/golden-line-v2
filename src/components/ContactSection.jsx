...
const SERVICES = [
  { key: 'shields',  label: 'Shields & Plaques',    labelAr: 'الدروع التذكارية',       icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2L3 7v5c0 5 4 9 9 10 5-1 9-5 9-10V7L12 2z"/></svg> },
  ...
  { key: 'decor',    label: 'Metal Sculptures & Facades', labelAr: 'المجسمات المعدنية والبنايات',        icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="14" rx="2"/><path d="M7 21h10M12 17v4"/><path d="M7 8h10M7 11h6"/></svg> },
